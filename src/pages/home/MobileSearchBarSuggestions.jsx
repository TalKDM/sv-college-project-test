...
const MobileSearchBarSuggestions = (props) => {
    const { close, setCityName, cityName, cityKey, favCities, cityData, setCityData, setChosenCity, setCityData5Days } = props;

  return (
    <div className='home-upper-mobileSearchBar-suggestions'>
    {cityKey === null &&
    (
        <Loader />
    )}
    ...
    (
        cityKey.filter((val) => {
            ...
            return 
                ...
                return (
                    <div onClick={chooseCity} key={index} className='home-upper-mobileSearchBar-suggestions-result'>
                        <h5>{`${val.LocalizedName}, ${val.Country.LocalizedName}`}</h5>
...
export default MobileSearchBarSuggestions