...
const DefaultCity5Days = (props) => {
    const { defaultCity5Day } = props;
  return (
    <div className='forecast-main-null'>
        {
            defaultCity5Day === null ?
            (
                <Loader />
            )
            :
            (
                <>
                {
                        defaultCity5Day.DailyForecasts.map((day, index) => {
...
export default DefaultCity5Days